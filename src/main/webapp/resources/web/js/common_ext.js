/**
 * 全局通用js文件 common.info:存放全局通用属性 目录的对应js交互，
 * 请写在对应的cvresume.main.xxx_event方法里去，如要新增,命名规则：cvresume.main.目录名_event
 */
var common = common || {};
...
common.main = {
	    ...
	    cvresume_event:function(){	    	
	    	// 发布页面的下载按钮
	        $(document).on("click","#releaseDownloadPDFBtn",function(){
//	        	var targetResume = $("#canvas");
//	        	var copyResume = targetResume;
//	        	copyResume.width(targetResume.width());
//	        	copyResume.height(targetResume.height());
//	        	html2canvas(copyResume[0]).then(function(canvas) {
...
//	    		if(!downloadFlag){
	    			$.ajax({type : "get",
			    		cache: false,
			    		async : false,
			    		url : wbdcnf.base +"/file/pdf.jhtml?path=http://blog.csdn.net"
//			    		success : function(message) {
//			    			if(message.type=="success"){
//								downloadUrl=message.content;
//								downloadFlag=true
        ...
        create_resume:function(){
            ...
            function next() {
                ...
                if(_index <= 2){
                    ...
                    // $(".contain_list
					// .contain_inner_modal.show_modal").animate({top:"188px"},800)
                }
            }   // 第一步跳转第二步， 第二步跳转第三步

...
var messages = {
	...
	"http://static.500d.me/resources/500d/js/shop.dialog.ok": "确&nbsp;&nbsp;定",
	"shop.dialog.cancel": "取&nbsp;&nbsp;消",
	"shop.dialog.deleteConfirm": "您确定要删除吗？",
	"shop.dialog.clearConfirm": "您确定要清空吗？",
	"shop.validate.required": "必填",
	"shop.validate.email": "E-mail格式错误",
	"http://static.500d.me/resources/500d/js/shop.validate.url": "网址格式错误",
	"http://static.500d.me/resources/500d/js/shop.validate.date": "日期格式错误",
	...
	"http://static.500d.me/resources/500d/js/shop.validate.min": "不允许小于{0}",
	"http://static.500d.me/resources/500d/js/shop.validate.max": "不允许大于{0}",
...
if ($.validator != null) {
	$.extend($.validator.messages, {
		...
		url: message("http://static.500d.me/resources/500d/js/shop.validate.url"),
		date: message("http://static.500d.me/resources/500d/js/shop.validate.date"),
		...
		min: $.validator.format(message("http://static.500d.me/resources/500d/js/shop.validate.min")),
		max: $.validator.format(message("http://static.500d.me/resources/500d/js/shop.validate.max")),

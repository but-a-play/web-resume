...
loginMain.email_hash={
		'http://static.500d.me/resources/500d/js/qq.com': 'http://mail.qq.com/',
		'http://static.500d.me/resources/500d/js/gmail.com': 'http://mail.google.com/',
		'http://static.500d.me/resources/500d/js/sina.com': 'http://mail.sina.com.cn/',
		'http://static.500d.me/resources/500d/js/163.com': 'http://mail.163.com/',
		'http://static.500d.me/resources/500d/js/126.com': 'http://mail.126.com/',
		'http://static.500d.me/resources/500d/js/yeah.net': 'http://www.yeah.net/',
		'http://static.500d.me/resources/500d/js/sohu.com': 'http://mail.sohu.com/',
		'http://static.500d.me/resources/500d/js/tom.com': 'http://mail.tom.com/',
		'http://static.500d.me/resources/500d/js/sogou.com': 'http://mail.sogou.com/',
		'http://static.500d.me/resources/500d/js/139.com': 'http://mail.10086.cn/',
		'http://static.500d.me/resources/500d/js/hotmail.com': 'http://www.hotmail.com/',
		'http://static.500d.me/resources/500d/js/live.com': 'http://login.live.com/',
		'http://static.500d.me/resources/500d/js/live.cn': 'http://login.live.cn/',
		'http://static.500d.me/resources/500d/js/live.com.cn': 'http://login.live.com.cn/',
		'http://static.500d.me/resources/500d/js/189.com': 'http://webmail16.189.cn/webmail/',
		'http://static.500d.me/resources/500d/js/yahoo.com.cn': 'http://mail.cn.yahoo.com/',
		'http://static.500d.me/resources/500d/js/yahoo.cn': 'http://mail.cn.yahoo.com/',
		'http://static.500d.me/resources/500d/js/eyou.com': 'http://www.eyou.com/',
		'http://static.500d.me/resources/500d/js/21cn.com': 'http://mail.21cn.com/',
		'http://static.500d.me/resources/500d/js/188.com': 'http://www.188.com/',
		'http://static.500d.me/resources/500d/js/foxmail.coom': 'http://www.foxmail.com/'
};
loginMain.main = {
    ...
    get_login_status:function(){//获取登录或的状态
    	...
    	if(getCookie("memberIsBindWeixin")=="false"){
    		if(!loginMain.main.isNull(redirectUrl)){
    			location.href="http://static.500d.me/login/bind_weixin/?redirectUrl="+decodeURI(redirectUrl);
    		}else{
    			location.href="http://static.500d.me/login/bind_weixin/";
    		}
    		//跳转到绑定微信页面
    		return;
    	}
    	...
    	if(getCookie("memberIsVerifyEmail")=="false"&&getCookie("memberIsVerifyMobile")=="false"){
    		if(!loginMain.main.isNull(redirectUrl)){
    			location.href="http://static.500d.me/login/bind_mobile/?redirectUrl="+decodeURI(redirectUrl);
    		}else{
    			location.href="http://static.500d.me/login/bind_mobile/";
    		}
    		return;
    	}
    	//检查用户是否为团体会员
    	$.post("/bind/check_information/",function(data){
    		if(data.type == "success"){
    			var options = {
					title:'',
					content_html:'<div class="associate_success_contain"><h6>关联成功，已开通团体会员权限</h6><span>正在跳转个人中心.......</span><p>没有跳转？<a href="http://static.500d.me/member/">点此手动跳转</a></p></div>',
					modal_class:'associate_success_modal'
				}
				common.main.resume_confirm(options);
				setTimeout(function(){
					window.location.href = 'http://static.500d.me/member/';
				},1000);
			}else{
				if(loginMain.main.isNull(redirectUrl)){
		    		location.reload();
				...
				$.ajax({
					...
					success: function(message) {
						if (message.type == "success") {
							...
							loginMain.main.get_login_status();
//							setTimeout(function(){
//								location.href="http://static.500d.me/register/register_success/"
//							},1500);
						} else {
    	 ...
    	 if(find_type=="mobile"){//手机
    		 ...
    		 if(flag){
    			 if(submit_type=="ajax"){
    				...
    				setTimeout(function(){
    					 location.href="http://static.500d.me/password/findpswdphone/?mobile="+username;
    				},1500)
    			 }
    		 }
    		 form.find(".loading1").hide();
    		 ...
    		 var send_url="/password/findbyemail/";
 			 ...
 			 if(send_flag){
 				 if(submit_type=="ajax"){
     				...
     				setTimeout(function(){
	   					 location.href="http://static.500d.me/password/findpswdemail/?email="+encodeURI(username);
	   				},1500)
	   			 }
 			 }
 			 form.find(".loading1").hide();
			...
			success: function(data) {
				...
				$.ajax({
					...
					success: function(message) {
						...
						if (message.type == "success") {
							setTimeout(function(){
								location.href="http://static.500d.me/password/find_success/";
							},1500)
						}
						form.find("button").prop("disabled", false);
						form.find(".loading1").hide();
					...
					success: function(message) {
						if (message.type == "success") {
		    				...
		    				if(!loginMain.main.isNull(redirectUrl)){
		    	    			...
		    	    			setTimeout(function(){
									location.href="http://static.500d.me/";
								},2000);
		    	    		}
						} else {
							layer.msg(message.content,{time:2000});
 	  ...
 	  $.ajax({
			...
			success: function(message) {
				if (message.type == "success") {
					...
					form.find("button").prop("disabled", false);
					setTimeout(function(){
						location.href="http://static.500d.me/member/";
					},2000);
				} else {
					layer.msg(message.content,{time:2000});
					form.find("button").prop("disabled", false);
			...
			success: function(data) {
				...
				$.ajax({
					...
					success: function(message) {
						...
						if (message.type == "success") {
							setTimeout(function(){
								location.href="http://static.500d.me/login/";
							},2000)
						}
						form.find("button").prop("disabled", false);
						form.find(".loading1").hide();
